...
import mobileElementLeft from "../Assets/Images/OurServices/element-mobile-left.svg";
  ...
  return (
    <>
      ...
      <div className="services__bottom">
        <img src={mobileElementLeft} alt="element" />
        <button className="btn">
          Все услуги
          <img src={btnArrow} alt="arrow" />
        </button>
        <img src={mobileElementRight} alt="element" />
      </div>
    </>
  );
};
